...
class TradeJournal:
    ...
    def append_trade_summary(self, position: Position, extra_payload: dict[str, Any] | None = None) -> None:
        ...
        summary: dict[str, Any] = {
            ...
            "burst_features": position.burst_features,
            ...
            "base_target_points": position.base_target_points,
            "promoted_target_points": position.promoted_target_points,
            "hard_stop_points_used": position.hard_stop_points_used,
            "promoted_3s_passed": position.promoted_3s_passed,
            "promoted_3s_reason": position.promoted_3s_reason,
            "velocity_0_1s": position.velocity_0_1s,
            "velocity_2_3s": position.velocity_2_3s,
            "velocity_decay_ratio_3s": position.velocity_decay_ratio_3s,
            "promotion_first_hit_trigger_time": position.promotion_first_hit_trigger_time,
            "promotion_deadline_time": position.promotion_deadline_time,
            "promotion_persistence_passed": position.promotion_persistence_passed,
            "promotion_persistence_exit_triggered": position.promotion_persistence_exit_triggered,
            ...
            "edge_stale_quote_flag": position.edge_stale_quote_flag,
            "edge_exit_candidate_reasons": position.edge_exit_candidate_reasons,
            "edge_exit_decision_reason": position.edge_exit_decision_reason,
            "edge_exit_decision_elapsed_seconds": position.edge_exit_decision_elapsed_seconds,
            "edge_exit_decision_pnl_points": position.edge_exit_decision_pnl_points,
            "edge_exit_decision_mfe_points": position.edge_exit_decision_mfe_points,
            "edge_exit_decision_mae_points": position.edge_exit_decision_mae_points,
